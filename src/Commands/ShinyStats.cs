namespace WhMgr.Commands
{
    ...
    public class ShinyStats
    {
        ...
        private static readonly List<int> _possiblyShinies = new List<int> { 1, 4, 7, 10, 16, 19, 23, 25, 27, 29, 32, 41, 50, 54, 56, 58, 60, 66, 74, 77, 81, 86, 88, 90, 92, 95, 96, 98, 103, 104, 109, 116, 123, 127, 129, 131, 133, 138, 140, 142, 147, 152, 155, 158, 177, 179, 190, 191, 198, 200, 204, 207, 209, 213, 215, 220, 225, 228, 246, 252, 255, 258, 261, 263, 270, 276, 278, 280, 287, 296, 302, 303, 304, 307, 309, 311, 312, 315, 318, 320, 325, 327, 333, 337, 338, 339, 345, 347, 349, 351, 353, 355, 359, 361, 366, 370, 371, 374, 403, 425, 427, 436 };
