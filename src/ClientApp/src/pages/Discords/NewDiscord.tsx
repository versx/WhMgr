...
class NewDiscord extends React.Component<IGlobalProps> {
    public state: any;
    ...
    fetchData() {
        fetch(config.apiUrl + 'admin/discord/data', {
            method: 'GET',
            headers: {
    ...
    handleSubmit(event: React.FormEvent<HTMLFormElement>) {
        ...
        fetch(config.apiUrl + 'admin/discord/new', {
            method: 'POST',
          ...
          .then((data: any) => {
            ...
            window.location.href = config.homepage + 'discords';
        }).catch((err) => {
            console.error('error:', err);
            event.preventDefault();
        });
...
export default withRouter(NewDiscord);