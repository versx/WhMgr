namespace WhMgr.Data.Subscriptions
{
    ...
    public class SubscriptionManager
    {
        ...
        //public bool AddPvP(ulong guildId, ulong userId, int pokemonId, string form = null, int rank = 0)
        //{
        //    _logger.Trace($"SubscriptionManager::AddPvP [GuildId={guildId}, UserId={userId}, PokemonId={pokemonId}, Form={form}, Rank={rank}");
        ...
        //        {
        //            _logger.Debug($"PvP Pokemon Added!");
        //        }
        //        else
        //        {
        //            _logger.Debug("PvP Pokemon Updated!");
        //        }
        ...
        //    {
        //        _logger.Error(ex);
        //        return AddPvP(guildId, userId, pokemonId, form, rank);
        //    }
        //    catch (Exception ex)
        //    {
        //        _logger.Error(ex);
        ...
        //public bool RemovePvP(ulong guildId, ulong userId, Dictionary<int, string> pokemonIds)
        //{
        //    _logger.Trace($"SubscriptionManager::RemovePvP [GuildId={guildId}, UserId={userId}, PokemonIds={pokemonIds}]");
        ...
        //        //PvP subscription exists, check if values are the same.
        //        pkmnSub.MinimumRank = 0;
        //        var result = conn.Save(pkmnSub, true);
        //        if (result)
        //        {
        //            _logger.Warn($"Could not delete PvP Pokemon {pokemonId}-{form} from {userId} subscription.");
        //        }
        //    }
